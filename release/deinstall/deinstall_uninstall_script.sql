...
drop type v_svt_sert_nt;
drop type v_svt_sert__0_nt;
...
drop type v_svt_sert_ot;
drop type v_svt_sert__0_ot;
...
drop table svt_sert_how_to_fix cascade constraints;
drop table svt_standards_urgency_level cascade constraints;
drop table mv_issues_created_by_day cascade constraints;
drop table mv_svt_bc_entries cascade constraints;
drop table mv_svt_buttons cascade constraints;
drop table mv_svt_card_actions cascade constraints;
drop table mv_svt_chart_s cascade constraints;
drop table mv_svt_classic_cols cascade constraints;
drop table mv_svt_home_link cascade constraints;
drop table mv_svt_ig cascade constraints;
drop table mv_svt_ig_cols cascade constraints;
drop table mv_svt_ir cascade constraints;
drop table mv_svt_ir_cols cascade constraints;
drop table mv_svt_list_entries cascade constraints;
drop table mv_svt_nav_bar cascade constraints;
drop table mv_svt_page_branch cascade constraints;
drop table mv_svt_page_menu_entries cascade constraints;
drop table mv_svt_search_config cascade constraints;
...
drop package svt_apex_sert_util;

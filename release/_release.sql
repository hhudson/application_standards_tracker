...
@all_functions.sql
@all_procedures.sql
@oracle_apex_version.sql
@all_synonyms.sql

@all_tables.sql
@all_foreign_keys.sql
@all_types.sql
@all_package_specs.sql
@all_sequences.sql
@all_mviews.sql

@all_views_ohms_apex.sql
@all_views_ohms_apex_meta.sql
@all_views_ohms_plsql.sql
@all_views_ohms_plsql_meta.sql
@all_views_ohms_db_view.sql
@all_views_ohms_db_view_meta.sql

@all_views_sert.sql
@all_views_sert_meta.sql

@all_views_meta.sql
@all_views.sql

@all_package_bodies.sql
@all_jobs.sql

@set_review_schema.sql

prompt Invalid objects
select object_name, object_type
from user_objects
where status != 'VALID'
-- and object_name not like '%SERT%'
-- and object_name not like '%AUTOMATIONS%'

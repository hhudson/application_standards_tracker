...
--changeset view_script:v_eba_stds_inherited_tests_tree stripComments:false endDelimiter:/ runOnChange:true
--------------------------------------------------------
--  DDL for View v_eba_stds_inherited_tests_tree
--------------------------------------------------------

create or replace force editionable view v_eba_stds_inherited_tests_tree as
...
from eba_stds_inherited_tests esit
...
--rollback drop view v_eba_stds_inherited_tests_tree;
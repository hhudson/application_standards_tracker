...
--changeset table_script:EBA_STDS_APP_STATUSES stripComments:false 
...
/
  ...
  CREATE UNIQUE INDEX EBA_STAPST_IDX1 ON EBA_STDS_APP_STATUSES (NAME) 
...
/
  ...
  ALTER TABLE EBA_STDS_APP_STATUSES MODIFY (NAME NOT NULL ENABLE)
/

...
--liquibase formatted sql
--changeset table_script:SVT_AUDIT_ON_AUDIT.TEST_CODE stripComments:false runOnChange:true
--preconditions onFail:MARK_RAN onError:HALT
--precondition-sql-check expectedResult:0 select count(1) from all_tab_cols where table_name = 'SVT_AUDIT_ON_AUDIT' and column_name = 'TEST_CODE';

alter table SVT_AUDIT_ON_AUDIT add test_code varchar2(100)
/

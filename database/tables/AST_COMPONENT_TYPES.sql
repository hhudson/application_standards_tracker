...
--changeset table_script:AST_COMPONENT_TYPES stripComments:false runOnChange:true
--preconditions onFail:MARK_RAN onError:HALT
--precondition-sql-check expectedResult:0 select count(1) from all_tables where upper(table_name) = upper('AST_COMPONENT_TYPES');
------------------------------------------------------------------------------
...
--
------------------------------------------------------------------------------
create table ast_component_types (
...
/
ALTER TABLE ast_component_types ADD CONSTRAINT uk_componentname UNIQUE(component_name);
/
ALTER TABLE ast_component_types ADD CONSTRAINT ast_component_types_pk PRIMARY KEY (id);
/
...
--rollback drop table AST_COMPONENT_TYPES;
  
  CREATE INDEX AST_COMPONENT_TYPES_IDX1 ON AST_COMPONENT_TYPES (NT_TYPE_ID) 
  
 ALTER TABLE AST_COMPONENT_TYPES MODIFY (NT_TYPE_ID NOT NULL ENABLE)
/
ALTER TABLE ast_component_types

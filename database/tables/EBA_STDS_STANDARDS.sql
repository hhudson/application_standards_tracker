...
/
 ...
 ALTER TABLE EBA_STDS_STANDARDS ADD (COMPATIBILITY_MODE_ID NUMBER)
/

  ALTER TABLE EBA_STDS_STANDARDS MODIFY (COMPATIBILITY_MODE_ID NOT NULL ENABLE)
/

ALTER TABLE EBA_STDS_STANDARDS ADD CONSTRAINT EBA_STDSTN_UK UNIQUE (STANDARD_NAME, COMPATIBILITY_MODE_ID)
/

 ALTER TABLE EBA_STDS_STANDARDS ADD (PARENT_STANDARD_ID NUMBER)
/

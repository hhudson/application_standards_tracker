...
--changeset package_script:AST_MONITORING stripComments:false endDelimiter:/ runOnChange:true
create or replace package AST_MONITORING authid definer as
----------------------------------------------------------------------------
...
/*
select ast_monitoring.unassigned_src_html (
...
procedure send_update(p_days_since     in number default 1,
  ...
  -- Synopsis:
  --
  -- function to get the url to the AST application
  --
  /*
  select ast_monitoring.app_url
  from dual;
  */
  ------------------------------------------------------------------------------
...
--
/*
select ast_monitoring.get_db_name
from dual;
*/
------------------------------------------------------------------------------
...
--
/*
select ast_monitoring.unassigned_html_by_src
                        (p_days_since => 2) uhbs
from dual;
*/
------------------------------------------------------------------------------
...
--
/*
select ast_monitoring.db_unique_name
from dual
*/
------------------------------------------------------------------------------

...
--changeset package_script:AST_APEX_ISSUE_UTIL stripComments:false endDelimiter:/ runOnChange:true
create or replace package ast_apex_issue_util authid current_user as
----------------------------------------------------------------------------
...
/*
begin
  ast_apex_issue_util.manage_apex_issues;
  commit;
end;
*/
------------------------------------------------------------------------------
...
-- begin
--     ast_apex_issue_util.create_issue (
--         p_id             => l_id,
--         p_title          => 'Test issue',
...
/*
begin
  ast_apex_issue_util.merge_from_audit_tbl(
...
-- Synopsis:
--
-- Update ast_plsql_apex_audit with the changes that have been performed to apex_issues
--
-- begin
...
/*
begin
    ast_apex_issue_util.drop_issue (p_id => 270816420201692571);
end;
*/
------------------------------------------------------------------------------
...
/*
begin
  ast_ctx_util.set_review_schema (p_schema => 'CARS');
  ast_apex_issue_util.refresh_for_standard_app_page (
...
begin
  ast_ctx_util.set_review_schema (p_schema => 'CARS');
  ast_apex_issue_util.refresh_for_audit_id (123);
end;
*/
------------------------------------------------------------------------------
...
/*
begin
  ast_apex_issue_util.check_apex_version_up2date;
end;
*/
------------------------------------------------------------------------------
...
/*
begin
  ast_apex_issue_util.mark_as_exception (p_audit_id => :P1_AUDIT_ID);
end;
*/
------------------------------------------------------------------------------
...
/*
begin
  ast_apex_issue_util.bulk_mark_as_exception (p_audit_ids => :P21_SELECTED_IDS);
end;
*/
------------------------------------------------------------------------------

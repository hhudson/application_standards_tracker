...
create or replace package eba_stds_parser authid definer as
    ...
    g_dummy_name constant eba_stds_standard_tests.name%type := 'DUMMY';
...
-- Synopsis:
--
-- function to replace build_link using v_ast_flow_dictionary_views.link_url/component_type_id 
...
set serveroutput on
declare
l_component_name    ast_component_types.component_name%type;
l_component_type_id v_ast_flow_dictionary_views.component_type_id%type;
l_template_url      v_ast_flow_dictionary_views.link_url%type;
begin

...
--changeset mview_script:MV_SVT_PAGE_MENU_ENTRIES stripComments:false runOnChange:true
--preconditions onFail:MARK_RAN onError:HALT
--precondition-sql-check expectedResult:0 select count(1) from all_tables where upper(table_name) = upper('MV_SVT_PAGE_MENU_ENTRIES');

--------------------------------------------------------
--  DDL for Materialized View MV_SVT_PAGE_MENU_ENTRIES
/*
begin
  dbms_mview.refresh ('MV_SVT_PAGE_MENU_ENTRIES');
end;
*/
--------------------------------------------------------

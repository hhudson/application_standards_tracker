...
--changeset package_body_script:ast_menu_util_body stripComments:false endDelimiter:/ runOnChange:true

create or replace package body ast_menu_util as
----------------------------------------------------------------------------
...
/
--rollback drop package body ast_menu_util;
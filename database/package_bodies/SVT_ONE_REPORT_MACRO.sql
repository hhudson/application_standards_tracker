...
--changeset package_body_script:SVT_ONE_REPORT_MACRO stripComments:false endDelimiter:/ runOnChange:true
create or replace PACKAGE BODY SVT_ONE_REPORT_MACRO as
-- SQL Macro

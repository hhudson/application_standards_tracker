...
--changeset package_body_script:SVT_URGENCY_LEVEL_API_body stripComments:false endDelimiter:/ runOnChange:true

create or replace package body SVT_URGENCY_LEVEL_API as
----------------------------------------------------------------------------
...
/
--rollback drop package body SVT_URGENCY_LEVEL_API;
...
--changeset package_body_script:SVT_APEX_ISSUE_LINK stripComments:false endDelimiter:/ runOnChange:true
create or replace package body SVT_APEX_ISSUE_LINK as
----------------------------------------------------------------------------

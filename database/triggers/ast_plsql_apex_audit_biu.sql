...
--changeset trigger_script:AST_PLSQL_APEX_AUDIT_BIU stripComments:false  endDelimiter:/ runOnChange:true
--------------------------------------------------------------------------------
--
--      Author:  hayden.h.hudson@oracle.com
-- Script name:  AST_PLSQL_APEX_AUDIT_BIU.sql
--        Date:  04-Apr-2023 19:52
--     Purpose:  BIU Trigger creation DDL for table AST_PLSQL_APEX_AUDIT
--
--------------------------------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER AST_PLSQL_APEX_AUDIT_BIU 
...
end ast_plsql_apex_audit_biu;
/

ALTER TRIGGER AST_PLSQL_APEX_AUDIT_BIU ENABLE
/

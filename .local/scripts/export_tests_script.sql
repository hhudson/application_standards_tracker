...
select svt_deployment.json_standard_tests_clob (p_standard_id => %2, p_test_code => '%0') thejsonclob from dual;]', vess.test_code, eba_stds.file_name(vess.calling_standard_name), ess.id, vess.file_name) stmt

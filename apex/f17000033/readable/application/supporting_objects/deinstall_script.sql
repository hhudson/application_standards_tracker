...
drop type v_svt_stds_standard_tests_nt;
...
drop table svt_stds_applications cascade constraints;
drop table svt_stds_error_lookup cascade constraints;
drop table svt_stds_inherited_tests cascade constraints;
drop table svt_stds_notifications cascade constraints;
drop table svt_stds_standards cascade constraints;
drop table svt_stds_standard_tests cascade constraints;
drop table svt_stds_tests_lib cascade constraints;
drop table svt_stds_types cascade constraints;
drop table svt_test_timing cascade constraints;
/*
select apex_string.format('drop materialized view %0;',lower(table_name)) stmt
from user_tables
...
drop package svt_stds;
drop package svt_stds_applications_api;
drop package svt_stds_data;
drop package svt_stds_inherited_tests_api;
drop package svt_stds_notifications_api;
drop package svt_stds_parser;
drop package svt_stds_standards_api;
drop package svt_stds_standard_tests_api;
drop package svt_stds_tests_lib_api;
drop package svt_stds_types_api;
...
from user_views
where (lower(view_name) like '%svt%' or lower(view_name) like '%v_user%')
order by view_name;
*/
drop view v_mv_svt;
drop view v_svt_all_standards_export;
drop view v_svt_apex_applications;
drop view v_svt_apex_application_page_ir_col;
drop view v_svt_apex_workspace_developers;
drop view v_svt_apex_workspace_preferences;
drop view v_svt_application_report_card;
drop view v_svt_audit_on_audit_apex;
drop view v_svt_audit_on_audit_keep_these;
drop view v_svt_automations_problems;
drop view v_svt_automations_status;
...
drop view v_svt_stds_applications;
drop view v_svt_stds_inherited_tests;
drop view v_svt_stds_inherited_tests_tree;
drop view v_svt_stds_standards;
drop view v_svt_stds_standards_export;
drop view v_svt_stds_standard_tests;
drop view v_svt_stds_standard_tests_export;
drop view v_svt_stds_standard_tests_w_inherited;
drop view v_svt_stds_tests_lib;

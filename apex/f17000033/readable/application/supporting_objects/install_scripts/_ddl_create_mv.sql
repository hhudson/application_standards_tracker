...
group by assignee;
 ...
 COLUMN STORE COMPRESS FOR QUERY HIGH ROW LEVEL LOCKING LOGGING
  ...
  CREATE UNIQUE INDEX "I_SNAP$_MV_SVT_ASSIGNEE_COUNT" ON "MV_SVT_ASSIGNEE_COUNT" (SYS_OP_MAP_NONNULL("ASSIGNEE")) 
  ;
  ...
  CREATE UNIQUE INDEX "SYS_IL0000505115C00008$$" ON "MV_SVT_IR" (
  ;
